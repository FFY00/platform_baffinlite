...
- How to build jl1.0.1.apk on Eclipse?
  Import the source files to new empty android project and build it.
  If you want to know how to make the android project, please refer http://developer.android.com/sdk/index.html
